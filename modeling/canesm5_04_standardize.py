# -*- coding: utf-8 -*-
"""
Standardize the selected CanESM5 XGBoost outputs for prediction and plotting.

The original selection rule is preserved: the latest completed FLASH and HAIL
run directories matching the training-script naming convention are selected.
This script does not retrain the models; it copies the selected model, feature
list, metrics, predictions and gain files into the common ``FINAL_XGB`` layout.

Run from the repository root:
    python -m modeling.canesm5_04_standardize
"""
