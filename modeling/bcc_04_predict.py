# -*- coding: utf-8 -*-
"""Generate BCC-CSM2-MR SSP585 decadal lightning and hail predictions.

The script uses the standardized models and feature lists produced by
``bcc_03_standardize.py`` and writes gridded prediction NetCDF files. Negative
predicted frequencies are clipped to zero following the modeling workflow.

Run from the repository root:
    python -m modeling.bcc_04_predict
"""
...
TRAIN_TABLE = TRAIN_DIR / "train_table_flash_hail_withSRTM_strictLand.parquet"
...
future_files = [SSP585_FEATURE_DIR / f"features_ssp585_{y0}_{y1}.parquet" for y0, y1 in DECADES]
