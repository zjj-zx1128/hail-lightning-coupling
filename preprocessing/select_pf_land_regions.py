# Purpose: select pf land regions.
...
# Run from repository root: python -m preprocessing.select_pf_land_regions
...
# 输入和输出路径
input_csv = resource_path('pf_processed', 'environment/variablesdata.csv')
output_folder = resource_path('pf_processed', 'environment/filtered_land_regions/')
