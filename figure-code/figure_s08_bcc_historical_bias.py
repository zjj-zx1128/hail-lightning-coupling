# Purpose: figure s08 bcc historical bias.
# Source: cmip6_figure_BCC_CMS2_MR_XGB_plot_latest_checked.ipynb; see docs/source_coverage.csv for cell provenance.
# Run order and required inputs: docs/workflow.md.
# Run from repository root: python -m figures.figure_s08_bcc_historical_bias

# ============================================================
# Step 10. Plot BCC-CSM2-MR historical predicted - observed maps
#
# 对应目标图：
#   Figure S9:
...
#
# 输出：
#   figure_s08_bcc_historical_bias_maps.png
#   figure_s08_bcc_historical_bias_vectors.csv
#   figure_s08_bcc_historical_bias_grids.npz
# ============================================================
...
OUT_PNG = OUT_DIR / 'figure_s08_bcc_historical_bias_maps.png'
OUT_VECTOR_CSV = OUT_DIR / 'figure_s08_bcc_historical_bias_vectors.csv'
OUT_GRID_NPZ = OUT_DIR / 'figure_s08_bcc_historical_bias_grids.npz'
